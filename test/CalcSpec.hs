...
testCalcDividendProfit = do
  ...
  where
    cr = createDividendRowWithPlaceHolders
...
createBuySellRowWithPlaceHolders action amnt qty =
  GenericTransaction
    { date = placeHolder,
      account = placeHolder,
      action = action,
...
createDividendRowWithPlaceHolders amnt =
  GenericTransaction
    { date = placeHolder,
      account = placeHolder,
      action = Dividend,
...
createSplitRowWithPlaceHolders qty =
  GenericTransaction
    { date = placeHolder,
      account = placeHolder,
      action = Split,
