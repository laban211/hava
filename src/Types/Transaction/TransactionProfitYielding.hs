...
import           Types.Transaction.GenericTransaction
                                                ( GenericTransaction(..) )
import qualified Types.Transaction.GenericTransaction
...
import           Types.Transaction.TransactionDividend
                                                ( TransactionDividend(..) )
import qualified Types.Transaction.TransactionDividend
                                               as TransactionDividend
